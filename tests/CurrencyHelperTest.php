...
final class CurrencyHelperTest extends TestCase
{
    public function testCanFormatJPY()
    {
        ...
        $this->assertEquals(
            '153',
            CurrencyHelper::format($value, 'JPY')
        );
    }
    ...
    public function testCanFormatEUR()
    {
        ...
        $this->assertEquals(
            '152.32',
            CurrencyHelper::format($value, 'EUR')
        );
    }
    ...
    public function testCanFormatUSD()
    {
        ...
        $this->assertEquals(
            '152.32',
            CurrencyHelper::format($value, 'USD')
        );
    }
    ...
    public function testCanConvertEURJPY()
    {
        ...
        $this->assertEquals(
            $jpy,
            CurrencyHelper::convert('EUR', 'JPY', $eur)
        );
    }
    ...
    public function testCanConvertJPYEUR()
    {
        ...
        $this->assertEquals(
            $eur,
            CurrencyHelper::convert('JPY', 'EUR', $jpy)
        );
    }
    ...
    public function testCanConvertEURUSD()
    {
        ...
        $this->assertEquals(
            $usd,
            CurrencyHelper::convert('EUR', 'USD', $eur)
        );
    }
    ...
    public function testCanConvertUSDEUR()
    {
        ...
        $this->assertEquals(
            $eur,
            CurrencyHelper::convert('USD', 'EUR', $usd)
        );
    }
    ...
    public function testCanConvertEUREUR()
    {
        ...
        $this->assertEquals(
            $eur,
            CurrencyHelper::convert('EUR', 'EUR', $eur)
        );
    }
    ...
    public function testCanConvertUSDJPY()
    {
        ...
        $this->assertEquals(
            $jpy,
            CurrencyHelper::convert('USD', 'JPY', $usd)
        );
    }
    ...
    public function testCanConvertJPYUSD()
    {
        ...
        $this->assertEquals(
            $usd,
            CurrencyHelper::convert('JPY', 'USD', $jpy)
        );
    }
